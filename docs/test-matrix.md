...
- `scripts/phase2-field-evidence.sh --fps 120 --elapsed-seconds 420 --calibrate-used no 100:124 220:247 340:369 460:490 580:613`: helper prints one combined evidence block and exits non-zero if either the visible-latency gate or first-run gate fails.
