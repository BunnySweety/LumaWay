...
- `scripts/phase2-field-evidence.sh --fps 120 --elapsed-seconds 420 --calibrate-used no --silent-black no 100:124 220:247 340:369 460:490 580:613`: helper prints one combined evidence block and exits non-zero if the video-FPS gate, visible-latency gate, first-run gate, or no-silent-black gate fails.
