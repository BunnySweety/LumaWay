...
- `scripts/phase2-latency-summary.sh --fps 120 100:124 220:247 340:369 460:490 580:613`: helper converts video frame pairs into latency milliseconds and passes the 5-transition 300 ms gate; a failure case with one 400 ms transition exits non-zero.
