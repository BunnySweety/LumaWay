...
| 1.2 | **Câbler l’intensité** | `preset_row()` → `LUMAWAY_REACTIVITY` (§6.1) ; retirer le curseur « Reactivity » de l’accueil ; tuiles **insensibles pendant sync** ; défaut Jeu : tuile High ou Max au premier run. |
