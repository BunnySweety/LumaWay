...
Date : 2026-05-15  
Dernière revue : 2026-05-15 (Phase 1.11 — bouton Start/Stop unique, Réglages bloqués pendant sync)
...
| 1 | En cours | Tâches 1.1 / 1.2 / 1.3 lancées ; 1.4 socle livré : tuiles Mode et Intensité branchées, Music désactivé, Start propage mode/réactivité/profil, accueil/réglages/statuts et erreurs principales traduits ; 1.5 livré : réglages techniques et journal repliés ; 1.11 livré : bouton unique et Réglages bloqués pendant sync |
| 2 | À faire | |
| 3 | À faire | |
| 4 | À faire | |
